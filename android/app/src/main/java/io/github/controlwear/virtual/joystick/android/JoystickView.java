...
import edu.pitt.engineering.joygrabber.R;
...
//    private static final int DEFAULT_COLOR_BUTTON = Color.BLACK;
    private static final int DEFAULT_COLOR_BUTTON = Color.rgb(102,0,0);

    /**
     * Default color for border
     */
    private static final int DEFAULT_COLOR_BORDER = Color.rgb(242,242,242);
